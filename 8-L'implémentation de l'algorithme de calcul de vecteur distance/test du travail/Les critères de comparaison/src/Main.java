...
public class Main {
	...
	public static void main(String[] args) {
		String chemin="C:\\BT";//chemin des fichier  à  tester
		int colonne=12;//nombre des colonnes 
		String ch="C:\\VM12";// chemin des vecteurs moyennes 
		Criteres c=new Criteres(colonne,ch);		
		File file = new File(chemin);// ouvrir dossier 
        File[] files = file.listFiles();// selection des fichier du chemin
        for(File f:files)
        {
        	...
        	if(c.VM.elementAt(i).length == ligne)	
        	{
        		...
        		System.out.println("Phoneme "+f.getName()+" Appartient à la classe "+indice_classe);
        	}
