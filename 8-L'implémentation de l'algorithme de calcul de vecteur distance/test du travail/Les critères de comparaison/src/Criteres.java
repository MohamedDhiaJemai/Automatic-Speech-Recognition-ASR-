...
public class Criteres {
	...
	//Constructeur
	public Criteres(int nbc,String chemin)
	{
		this.nombre_colonnes=nbc;//le nombre de colonne 
	...
	// calculer le nombre des lignes dans une fichier 
	...
	public double euclidienne_Matrice(double[][] m1,double[][] m2)
	{
		...
		double somme=0;
		//System.out.println("nmbres des colonnes = "+nombre_colonnes);
